...
// Get the DOM element with the ID "muteButton" and assign it to the variable "muteButton"
let muteButton = document.getElementById("muteButton");

// Define a function named "muteUnmute"
function muteUnmute(){
// Check if the "muted" property of the video element is true
if (videoElement.muted) {
// If the video is currently muted, unmute it and change the background image of the mute button
videoElement.muted = false;
muteButton.style.backgroundImage = "url('./icons/mute.svg')";
} else {
// If the video is not currently muted, mute it and change the background image of the mute button
videoElement.muted = true;
muteButton.style.backgroundImage = "url('./icons/unmute.svg')";
}
}

// Add an event listener to the "muteButton" element, which will trigger the "muteUnmute" function when the button is clicked
